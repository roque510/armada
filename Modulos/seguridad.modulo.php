    ...
    <div class="card-panel hoverable" style="width: 95%; margin: 0px auto 20px;">            
      ...
      <div class="row container" style="margin-bottom:1px;">
        <div class="col s12">
          <div class="input-field col s12 m6">        
            ...
            <input id="usuario_nombres" name="usuario_nombres" type="text" class="validate" style='text-align:center'>
          ...
          <div class="input-field col s12 m6">        
            <input id="usuario_apellidos" name="usuario_apellidos" type="text" class="validate" style='text-align:center'>
      ...
      <div class="row container" style="margin-bottom:1px;">
        <div class="col s12" >
          <div class="input-field col s12 m6">
            ...
            <input id="usuario_alias" name="usuario_alias" type="text" class="validate" style='text-align:center'>
          ...
          <div class="input-field col s12 m6">
            <input id="usuario_password" name="usuario_password" type="password" class="validate" style='text-align:center'>
      ...
      <div class="row container" style="margin-bottom:1px;">
        <div class="col s12" >
          <div class="input-field col s12 m6">        
            ...
            <input id="usuario_cell" name="usuario_cell" type="text" class="validate" style='text-align:center'>
          ...
          <div class="input-field col s12 m6">        
            <input id="icon_prefix" name="usuario_telefono" type="text" class="validate" style='text-align:center'>
      ...
      <div class="row container">
        ...
        <div class="col s12 m6" style="text-align:center; margin-top:21px;">
          <input type="checkbox" name="usuario_isAdmin" class="filled-in" id="filled-in-box"  />
