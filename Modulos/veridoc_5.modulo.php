  ...
  <ul class="pagination">
    ...
    <li class="active teal"><a href="?pg=veridoc_5">Datos de Venta</a></li>
    <li class="waves-effect"><a href="#!"><i class="material-icons">chevron_right</i></a></li>
    <li class="waves-effect right"><a href="javascript: sweet_alert()" class="right waves-effect waves-light btn col s12 m3" style="color:white; font-size:15px;"><i class="material-icons left" style="font-size:25px;">undo</i>Devolver</a></li>
  </ul>      
<div class="progress">
