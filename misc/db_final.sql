...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-06-2016 a las 20:48:11
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla donde se almacenaran los tipos de cargos que puede llegar a tener un cliente de segundo nivel en su lugar de trabajo.' AUTO_INCREMENT=8 ;
...
CREATE TABLE IF NOT EXISTS `cias` (
  ...
  `estatus_id` varchar(2) DEFAULT NULL,
  PRIMARY KEY (`cia_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla en donde se guardaran todas las compañias y sus datos generales, los cuales seran los clientes internos directos del sistema CrediStar. Dicha tabla es la escencia cuando se se desee agregar un nuevo cliente de primer nivel.' AUTO_INCREMENT=3 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla en donde se guardaran las entidades que sean clasificadas como tipo clientes en el sistema CrediStar' AUTO_INCREMENT=11 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla general de las direcciones, es la tabla que contendra la relacion de todas las tablas de ubicaciones como pais, departamentos, ciuidades y colonias para que el sistema vaya generando una base de conocimiento de las direcciones.' AUTO_INCREMENT=16 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla en donde se almacenara los empleos que actualmente tienen cada uno de los clientes de segundo nivel ingresados, los cuales se realacionaran directmaente con una empresa.' AUTO_INCREMENT=5 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla general en donde se almacenaran las entidades tanto de: clientes de segundo nivel, referencias personales, jefes de empleos, etc. la idea es que esta tabla almacene cualquier dato que se pueda reutilizar luego.' AUTO_INCREMENT=88 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla en donde se registraran los grupos principales de usuarios, esto nos srevira para poder definir los perfiles de accesos y grupos de pantallas' AUTO_INCREMENT=3 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla la cual almacenara todas las diferentes identificaciones que una sola entidad puede llegar a manejar.' AUTO_INCREMENT=84 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla en donde se ingresaran las propiedades que puede llegar a tener un cliente de segun do nivel registrado en el sistema CrediStar.' AUTO_INCREMENT=13 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla en donde se relacionaran las diferentes  referencias personales que puede llegar a tener una entidad.' AUTO_INCREMENT=9 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla de transacciones, en esta tabla se guardara el registro que sera el que inicie la afetacion de un credtio para un cliente en especifico.' AUTO_INCREMENT=18 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla en donde se almacenaran las sucursales de las compañias clientes primer nivel del sistema CrediStar.' AUTO_INCREMENT=4 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla que servira de registro maestro para los numeros de telefonos de las diferentes entidades del sistema' AUTO_INCREMENT=14 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla en donde se registraran todos los usuarios del sistema, con este registro y dependiendo de su nivel de acceso es donde se podra definir la seguridad a cada usuario.' AUTO_INCREMENT=6 ;
...
INSERT INTO `db_credistar`.`estatus` (`estatus_id`, `estatus_desripcion`, `estatus_comentario`) VALUES ('9', 'Atendiendo', 'solicitud');
--
